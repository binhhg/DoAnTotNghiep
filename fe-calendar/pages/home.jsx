...
export default function Home () {
  async function handlerSignGoogle () {
    ...
    await localStorage.setItem('account', false)
  ...
  return (
    ...
    >
      <div
        ...
        <div>Chào mừng bạn đến với iCalendar - nền tảng đồng bộ nhanh chóng và dễ dàng cho nhiều tài khoản cloud của
          bạn.
        </div>
        ...
        <div className="text-center flex flex-col gap-y-2" onClick={handlerSignGoogle}>
          <div
