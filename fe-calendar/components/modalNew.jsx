...
export default function ModalNew({show, handle}) {
    ...
    const [mailOption, setMailOption] = useState([
        {
            value: 1,
            label: "haoht@carpla.vn"
        }, {
            value: 2,
            label: "binhpt@carpla.vn"
        }
    ])
        ...
        return (
            <Form className="space-y-4" onSubmit={e => e.preventDefault()}>
                ...
                <Form.Group controlId="exampleForm.ControlInput1">
                    <Form.Control hidden={accounts.length !== 1} type="email" placeholder="Thêm khách" value={inputText} onChange={handleInputChange}
                ...
                <Form.Group>
                    <Form.Control as={'textarea'} row={'3'} placeholder={'Mô tả'}/>
                </Form.Group>
